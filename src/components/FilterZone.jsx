export default function FilterZone () {
  return (
    <section class='sticky top-28 rounded-2xl py-4 px-3 border border-[rgb(237,242,247)]'>
      <span class='block font-bold mb-3 leading-5'>Remote Location</span>
      <article class='grid gap-2 mb-4 grid-rows-3'>
        <label class='grid w-max cursor-pointer grid-cols-[repeat(2,fit-content(100%))] items-center gap-2'>
          ...
          <div class='grid grid-cols-[repeat(2,fit-content(100%))] gap-1 leading-5'>
